  ...
  return (
    <div className="wrap">
      <header className="masthead">
        ...
        <p className="lede">
          Three completed exclusion case studies define the boundary of the public
          release. Each shows why a firm cannot enter the study, separating limits of
          data reach from cases where the Merton model does not apply cleanly.
        </p>
      </header>

      <section className="section">
        <span className="flag">Completed exclusion cases</span>
